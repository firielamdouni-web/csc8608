...
# Configuration (adapter le chemin du checkpoint si besoin)
DATA_DIR = Path("TP1/data/images")
OUT_DIR = Path("TP1/outputs/overlays")
CKPT_PATH = "TP1/models/sam_vit_h_4b8939.pth"   # à adapter si vous utilisez vit_l/vit_b
MODEL_TYPE = "vit_h"
...
# session state for points guidance and last prediction
if "points" not in st.session_state:
    st.session_state["points"] = []  # list of (x,y,label) label:1=FG,0=BG
...
# Avertissement bbox très petite (bonus simple)
...
# Bloc de sélection du masque candidat (multimask)
lp = st.session_state.get("last_pred")
